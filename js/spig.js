...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到沈阳师范大学《' + title + '》', 6000);
    }
    $(".spig").animate({
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http:\/\/tianqi.xixik.com\/cframe\/1\" frameborder=\“0\” scrolling=\"no\" height=\"25px\"  width=\"170px\" allowtransparency=\"true\" ></iframe>", "快快订阅我的博客吧！<a href=\"https://zhanzhanqny.xyz/\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"/wp-content/themes/chromeStyle/images/rss.png\"></a>", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
